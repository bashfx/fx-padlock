# FUNC_META | src:/home/xnull/repos/code/shell/bashfx/fx-padlock/parts/09_key_api.sh | src_sum:e9fb365ce0c83b8e04e7a60e77f8660efb4e356a770fa7303a2a81d23e8cd466 | orig:do_key | edit:key_do_key | orig_sum:f0a8a2ada4837d6afb3371a588de5ef3753274536f9f566a745102a968957dcc
key_do_key() {
    local action="${1:-}"
    shift || true
