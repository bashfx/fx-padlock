# FUNC_META | src:/home/xnull/repos/code/shell/bashfx/fx-padlock/parts/07_ignition_api.sh | src_sum:ac6942ec5db5698ee7c01994f4c90857267326c2f3357757f50d88e537f8e6d7 | orig:do_unmap | edit:ignition_do_unmap | orig_sum:16d35e8812778346bcd3d6eb496af16c85c2486f528986942c7880a84bd53c32
ignition_do_unmap() {
    local target="${1:-}"
