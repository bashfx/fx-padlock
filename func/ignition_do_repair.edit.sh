# FUNC_META | src:/home/xnull/repos/code/shell/bashfx/fx-padlock/parts/07_ignition_api.sh | src_sum:ac6942ec5db5698ee7c01994f4c90857267326c2f3357757f50d88e537f8e6d7 | orig:do_repair | edit:ignition_do_repair | orig_sum:28c456fddc3a5aaff1ef63aaad12ac45f2a2737fdb2d34a264c6494f6b01f344
ignition_do_repair() {
    local repo_path="${1:-.}"
