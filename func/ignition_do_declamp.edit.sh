# FUNC_META | src:/home/xnull/repos/code/shell/bashfx/fx-padlock/parts/07_ignition_api.sh | src_sum:ac6942ec5db5698ee7c01994f4c90857267326c2f3357757f50d88e537f8e6d7 | orig:do_declamp | edit:ignition_do_declamp | orig_sum:48c166bf4e2a2cccc071ca59f2a2c03d131f34da4b00f967735e94e76c9a7e1e
ignition_do_declamp() {
    local repo_path="${1:-.}"
    local force="${2:-}"
