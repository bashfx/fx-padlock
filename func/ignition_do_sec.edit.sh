# FUNC_META | src:/home/xnull/repos/code/shell/bashfx/fx-padlock/parts/07_ignition_api.sh | src_sum:ac6942ec5db5698ee7c01994f4c90857267326c2f3357757f50d88e537f8e6d7 | orig:do_sec | edit:ignition_do_sec | orig_sum:a171d6a5161cee0ee5ea8855d62dc133702b759fadc37bb773faaf90fa9efdb4
ignition_do_sec() {
    local action="${1:-}"
