# FUNC_META | src:/home/xnull/repos/code/shell/bashfx/fx-padlock/parts/07_ignition_api.sh | src_sum:ac6942ec5db5698ee7c01994f4c90857267326c2f3357757f50d88e537f8e6d7 | orig:do_remote | edit:ignition_do_remote | orig_sum:625b7a78d2a3c3c7cefec47bb55697044b0bf20499e9a4b1665a2cbd0798419d
ignition_do_remote() {
    local repo_path="${1:-.}"
