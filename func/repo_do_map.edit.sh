# FUNC_META | src:/home/xnull/repos/code/shell/bashfx/fx-padlock/parts/08_repo_api.sh | src_sum:7653559b97e9662ff834af76ca6be09aada5e9098b294e7bbbb14a4e84c83334 | orig:do_map | edit:repo_do_map | orig_sum:b005628bc38a32b896d423f27414f7127b8f21150fa98aa43a1470c5dafec4e8
repo_do_map() {
    local src_path="${1:-}"
    local action="${2:-add}"
