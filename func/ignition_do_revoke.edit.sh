# FUNC_META | src:/home/xnull/repos/code/shell/bashfx/fx-padlock/parts/07_ignition_api.sh | src_sum:ac6942ec5db5698ee7c01994f4c90857267326c2f3357757f50d88e537f8e6d7 | orig:do_revoke | edit:ignition_do_revoke | orig_sum:2ebe8b17e3b1353268a6524b2632ff12e1ee889d13fdcc9700b74a8a4ab2792d
ignition_do_revoke() {
    local target="${1:-}"
    shift || true
