#!/usr/bin/env bash
# Generated by build.sh on Mon Sep  8 01:26:17 PM MDT 2025
# Auto-assembled from numbered modules: 01_header.sh 02_config.sh 03_stderr.sh 04_helpers.sh 05_printers.sh master_api.sh ignition_api.sh repo_api.sh key_api.sh 07_core.sh 08_main.sh 09_footer.sh
# === 01_header.sh ===
#!/usr/bin/env bash
#
#  ____            _  _            _    
