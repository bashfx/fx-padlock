#!/usr/bin/env bash
# Generated by build.sh on Mon Sep  8 01:36:17 PM MDT 2025
# Auto-assembled from numbered modules: 01_header.sh 02_config.sh 03_stderr.sh 04_helpers.sh 05_printers.sh 06_master_api.sh 07_ignition_api.sh 08_repo_api.sh 09_key_api.sh 10_core.sh 11_main.sh 12_footer.sh
# === 01_header.sh ===
#!/usr/bin/env bash
#
#  ____            _  _            _    
